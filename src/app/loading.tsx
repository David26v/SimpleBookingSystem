    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-[#bd1e59] to-[#92174d]">
        <div className="max-w-7xl mx-auto px-4 py-10 md:px-6 md:py-16">
          <div className="h-8 md:h-10 w-64 md:w-80 bg-white/20 rounded-lg animate-pulse mb-2 md:mb-3" />
          <div className="h-4 md:h-5 w-72 md:w-96 bg-white/15 rounded-lg animate-pulse mb-6 md:mb-8" />
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 md:px-6 md:py-10">
        <div className="h-7 md:h-8 w-48 bg-muted rounded-lg animate-pulse mb-2" />
        <div className="h-4 w-32 bg-muted/60 rounded animate-pulse mb-4 md:mb-6" />
